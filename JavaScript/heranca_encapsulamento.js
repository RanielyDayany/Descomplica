...
class Casa{
    constructor(cor, numQuarto, temGaragem){
        //Propriedades privadas utilizando convenção de underscore -> "_"
        this._cor = cor;
...
//A palavra que define que é uma herança é "extends"
class CasaLuxuosa extends Casa{
    constructor(cor, numDeQuartos, temGaragem, temPiscina){
        //Chama o construtor da classe base
        super(cor,numDeQuartos,temGaragem);
